...
import { ScheduleSettingForm } from "@/components/teachers/schedule-setting-form";
...
export function ScheduleSettingModal({ defaultSetting, onClose }: Props) {
      ...
      <div className="glass-panel w-full max-w-xl overflow-hidden bg-white">
        <div className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4">
          <div>
            ...
            <p className="text-lg font-semibold text-slate-900">수업 시간 설정</p>
          </div>
          <button
            type="button"
            onClick={handleClose}
